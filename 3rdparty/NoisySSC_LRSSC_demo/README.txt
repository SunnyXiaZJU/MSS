...
NOTES:
I changed the function soft_thresh and sigma_soft_thresh in this package, 
and rename the original one in this package by *_original, since the original
ones are incorrect in my opinion.